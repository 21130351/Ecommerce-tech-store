...
import com.techstore.backend.domain.PaymentMethod;
import com.techstore.backend.modal.*;
import com.techstore.backend.repository.PaymentOrderRepository;
import com.techstore.backend.response.PaymentLinkResponse;
import com.techstore.backend.service.*;
...
public class OrderController {
    ...
    public ResponseEntity<OrderItem> getOrderItemById(@PathVariable Long orderItemId, @RequestHeader("Authorization") String jwt)
        ...
        User user = userService.findUserByJwtToken(jwt);
        OrderItem orderItem = orderService.getOderItemById(orderItemId);
