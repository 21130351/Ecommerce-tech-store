...
const accountStatuses = [
  { status: 'PENDING_VERIFICATION', title: 'Pending Verification', description: 'Account is verifying' },
  ...
  { status: 'DEACTIVATED', title: 'Deactivated', description: 'Account is deactived and in bad status' },
        ...
        <Table sx={{ minWidth: 700 }} aria-label="customized table">
          <TableHead>
            <TableRow>
              ...
              <StyledTableCell align="right">MST(Mã số thuế)</StyledTableCell>
