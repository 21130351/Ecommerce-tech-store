...
//dữ liệu đã chuẩn bị để gửi API
// Cấu trúc dữ liệu của form tạo coupon
...
const AddNewCouponForm = () => {
  // Khởi tạo Formik để quản lý form coupon
  const formik = useFormik<CouponFormValues>({
    // Giá trị mặc định của các trường trong form
    initialValues: {
      code: "",
    ...
    onSubmit: (values) => {
      ...
      const formatedValues = {
        ...values,
        validityStartDate: values.validityEndDate?.toISOString(),
