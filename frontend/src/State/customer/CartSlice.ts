...
import { sumCartItemOrgPrice, sumCartItemSellingPrice } from "../../Util/sumCartItemOrgPrice";
    ...
    extraReducers: (builder) => {
        ...
        .addCase(deleteCartItem.fulfilled, (state, action)=> {
            if(state.cart) {
                ...
                const orgPrice = sumCartItemOrgPrice(state.cart?.cartItems || [])
                const sellingPrice=sumCartItemSellingPrice(state.cart?.cartItems || [])
                state.cart.totalSellingPrice=sellingPrice;
                state.cart.totalOrgPrice=orgPrice;
            }
            state.loading=false;
        })
...
// export const selecCartError = (state: RootState) => state.cart.error;