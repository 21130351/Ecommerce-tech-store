      ...
      <Table sx={{ minWidth: 700 }} aria-label="customized table">
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell align="right">Selling Price(Discount)</StyledTableCell>
        ...
        <TableBody>
          {sellerProduct.products.map((item:Product) => ( //nhan image tuong ung voi product tren table product cua seller
            <StyledTableRow key={item.id}>
              ...
              <StyledTableCell align="right">{item.orgPrice}</StyledTableCell>
