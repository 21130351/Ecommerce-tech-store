...
const steps = [
    ...
    { name: "Packed", description: "Item Packed in Dispatch Warehouse", value: "CONFIRMING"},
   ...
   // { name: "Cancelled", description: "by 16 Jul - 18 Jul", value: "CANCELLED"},
];
            ...
            {statusStep.map((step, index) => (
                ...
                <div key={index} className={`flex px-4`}>
                    ...
                    <div className={`ml-2 w-full`}>
                        {/* Highlight trạng thái hiện tại của đơn hàng */}
                        <div
